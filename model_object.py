...
models = {
    ...
    'TriLightNetMLP_replace_KAN': {
        'Name': 'TriLightNet',
        'Model': TriLightNetMLP_replace_KAN,
        'dataset': MriPetCliDataset,
        'shape': (96, 128, 96),
        'Loss': loss_for_tirlighetNet,
        'task': ("pMCI", "sMCI"),
    ...
    'TriLightNetNoMRI': {
        'Name': 'TriLightNetNoMRI',
        'Model': TriLightNetNoMRI,
        'dataset': MriPetCliDataset,
        'shape': (96, 128, 96),
        'Loss': loss_for_tirlighetNet,
        'task': ("pMCI", "sMCI"),
    ...
    'TriLightNetNoPET': {
        'Name': 'TriLightNetNoPET',
        'Model': TriLightNetNoPET,
        'dataset': MriPetCliDataset,
        'shape': (96, 128, 96),
        'Loss': loss_for_tirlighetNet,
        'task': ("pMCI", "sMCI"),
    ...
    'TriLightNetNoCli': {
        'Name': 'TriLightNetNoCli',
        'Model': TriLightNetNoCli,
        'dataset': MriPetCliDataset,
        'shape': (96, 128, 96),
        'Loss': loss_for_tirlighetNet,
        'task': ("pMCI", "sMCI"),
    ...
    'TriLightNetWithoutCBAMWithCasCadeKAN_Replace_MLP': {
        'Name': 'TriLightNetWithoutCBAMWithCasCadeKAN_Replace_MLP',
        'Model': TriLightNetWithoutCBAMWithCasCadeKAN_Replace_MLP,
        'dataset': MriPetCliDataset,
        'shape': (96, 128, 96),
        'Loss': loss_for_tirlighetNet,
        'task': ("pMCI", "sMCI"),
    ...
    'TriLightNetWithCBAMWithOutCasCadeMLP_replace_KAN': {
        'Name': 'TriLightNetWithCBAMWithOutCasCadeMLP_replace_KAN',
        'Model': TriLightNetWithCBAMWithOutCasCadeMLP_replace_KAN,
        'dataset': MriPetCliDataset,
        'shape': (96, 128, 96),
        'Loss': loss_for_tirlighetNet,
        'task': ("pMCI", "sMCI"),
    ...
    'TriLightNetWithOutCBAMWithoutCascadeMLP_replace_KAN': {
        'Name': 'TriLightNetWithOutCBAMWithoutCascadeMLP_replace_KAN',
        'Model': TriLightNetWithOutCBAMWithoutCascadeMLP_replace_KAN,
        'dataset': MriPetCliDataset,
        'shape': (96, 128, 96),
        'Loss': loss_for_tirlighetNet,
        'task': ("pMCI", "sMCI"),
...
"""
    ...
    model = TriLightNetWithCBAMWithOutCasCade()
    model = TriLightNetWithOutCBAMWithoutCascade()
    nohup python main_rebuild.py --model=TriLightNetNoMRI --device="cuda:3" > result_TriLightNetNoMRI.out &
"""
